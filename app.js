...
const getSearchItems = async (search) => {
    ...
    try {
        ...
        if (search && search.length > 0) {
          url = `${productsUrl}?description_contains=${search}`
        } else {
          url = `${productsUrl}`
        }
          ...
          `<div class="col-lg-4 col-md-6">
              <div class="product-item">
                  <div class="product-img">
                      <a href="#" data-toggle="modal" onclick="setProduct(${item})" data-target="#productModal">
                          <img src=${BASE_URL}${item.image?.url} alt=""/>
                      </a>
                  </div>
                  <div class="product-info">
                      <h6 class="product-title">
                          <a href="#" data-toggle="modal" onclick="setProduct(${item})" data-target="#productModal">${item.name} </a>
                      </h6>
                      ...
                      <h3 class="pro-price">KSh ${item.price}</h3>
              ...
              <div class="modal-product clearfix">
                  <div class="product-images">
                    <div class="main-image images">
                        <img alt="" src=${BASE_URL}${item.image?.url}>
                    </div>
                  </div><!-- .product-images -->
                  ...
                  <div class="product-info">
                    ...
                    <div class="price-box-3">
                        <div class="s-price-box">
                            <span class="new-price">KSh ${item.price}</span>
                            <span class="old-price">KSh ${item.old_price}</span>
                        </div>
                    </div>
